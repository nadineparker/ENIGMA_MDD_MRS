...
then
	...
	--out ${Project_Path}/anc_proj_files/${Sample_Name}_QC_ENIGMA_MDD
else
	cp ${REF_PLINKFILE}.bed ${Project_Path}/anc_proj_files/${Sample_Name}_QC_ENIGMA_MDD.bed
	cp ${REF_PLINKFILE}.bim ${Project_Path}/anc_proj_files/${Sample_Name}_QC_ENIGMA_MDD.bim
	cp ${REF_PLINKFILE}.fam ${Project_Path}/anc_proj_files/${Sample_Name}_QC_ENIGMA_MDD.fam
fi
